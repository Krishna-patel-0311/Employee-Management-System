...
namespace Employee_Management_System.Models
{
    public class EmployeeModel
    {
        ...
        public bool Insert(EmployeeModel emp)
        {
            ...
            using (SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\patel\Desktop\Employee Management System\Employee Management System\App_Data\Employee.mdf"";Integrated Security=True"))
            {
                con.Open();
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@LastName", string.IsNullOrEmpty(emp.LastName) ? DBNull.Value : (object)emp.LastName);
        ...
        public List<Employee> GetReportingEmployeeList()
        {
            ...
            using (SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\patel\Desktop\Employee Management System\Employee Management System\App_Data\Employee.mdf"";Integrated Security=True"))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT EmployeeID, FirstName, LastName FROM Employee where IsDeleted = 0", con))
                {
        ...
        LEFT JOIN Employee rp ON e.ReportingPersonID = rp.EmployeeID WHERE e.IsDeleted = 0 ";
            ...
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\patel\Desktop\Employee Management System\Employee Management System\App_Data\Employee.mdf"";Integrated Security=True");
